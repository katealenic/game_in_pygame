...
class Tiger(games.Sprite):
    image = games.load_image("Tiger17.gif")
    def __init__(self):
...
class Tree(games.Sprite):
    image = games.load_image("111.png")
    speed = 2
...
class Place(games.Sprite):
    ...
    def __init__(self, x = 1025, speed = 4, odds_change = 400):
        ...
        self.time_til_drop2 = 2
        self.time_til_drop3 = 3
